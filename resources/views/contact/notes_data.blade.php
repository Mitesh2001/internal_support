<div class="notes-area text-center">
                  ...
                  <div class="card-contetn">
                        <div class="card-body">
                              <form action="" id="notes-form" method="post">
                                    ...
                                    <input type="hidden" value="{{$contact->id}}" class="contact_id">
      ...
      <div class="card border border-secondary">
            <div class="card-contetn">
                  <div class="card-body">
                        <input type="text" placeholder="Add notes about this person ( things your team should know ) " class="form-control" id="collapse-btn" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                  </div>
            </div>
      </div>
</div>
