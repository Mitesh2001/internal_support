<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light" id="sidenav-main">
    <div class="container-fluid">
        ...
        <a class="navbar-brand mr-0 mr-md-2" href="{{ route('home') }}">
            <img  style="border-radius: 50%" height="120px" src="{{ asset('argon') }}/img/brand/support_logo.png" />
            {{-- <img  style="border-radius: 50%" height="120px" src="https://www.iconpacks.net/icons/1/free-user-headphone-icon-300-thumb.png" /> --}}
        </a>
        <!-- User -->
